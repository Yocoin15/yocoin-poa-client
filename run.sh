...
screen -dmS rpcnode /usr/bin/geth --rpcvhosts=* --bootnodes "$BOOTNODES" --datadir $DATADIR --syncmode 'full' --networkid 58008 --ws --ws.api admin,eth,net,web3,txpool,clique,trace  --ws.origins '*' --http --http.api admin,eth,net,web3,txpool,clique --http.corsdomain '*'
